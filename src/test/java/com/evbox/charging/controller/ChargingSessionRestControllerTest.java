...
public class ChargingSessionRestControllerTest {
	...
	void testSubmitChargingSession() throws Exception {
		...
		// when
		ChargingSessionsResponse chargingSession = new ChargingSessionsResponse(UUID.randomUUID(), stationId1, now(),
				Status.IN_PROGRESS);
	...
	void testStopChargingSession() throws Exception {
		...
		// when
		ChargingSessionsResponse chargingSession = new ChargingSessionsResponse(UUID.randomUUID(), id, now(),
				Status.FINISHED);
